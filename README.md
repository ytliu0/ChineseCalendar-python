...
Chinese version: [傳統中文](README_chinese.md)  [简体中文](README_simp.md)
...
[Quickstate guide](QuickStart.ipynb) shows the basic usage of the calendar-conversion functions provided by this package.

## Beyond basic usage

[Tutorial](tutorial/English/tutorial.ipynb) describes the calendar-conversion functions in more detail.

## Applications

[Calendar exercises](tutorial/English/calendar_exercises.ipynb) demonstrates how to use this package's functions to write code that can carry out more complicated calendar calculations.
